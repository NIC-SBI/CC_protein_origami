...
def chimera_color(json_file, out_file, model_number="", verbose=True):
    ...
    with open(out_file+'chimera', 'a') as f.
        for s in d.segments:
...
if __name__ == "main":
    ...
    parser.add_argument("-v","--verbose", default='color', help='print scripts to screen')
    

    a = parser.parse_args()

    chimera_color(a.json, a.output, verbose=a.verbose)
